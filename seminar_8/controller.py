from view import (get_employee, get_changes, get_id, get_first_name, get_last_name,
                  ...
                  show_search_menu, show_update_menu, no_employee_error, show_employee_info, get_experience)
from model import (read_csv, read_json, write_csv, write_json, find_employee_by_id,
                   ...
                   find_employee, find_employee_by_position, find_employees_by_experience)
...
def run_work():
    ...
    while True:
        ...
        if choice == 1:             # find employee
            ...
            emp_by_exp = find_employees_by_experience(employees)
            if not emp_by_exp:
                no_employee_error()
            else:
                for emp in emp_by_exp:
                    show_employee_info(emp)
            break
        else:
